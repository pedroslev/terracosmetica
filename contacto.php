...
<body
        ...
        <div id="et-top-navigation" data-height="150" data-fixed-height="40">
          <nav id="top-menu-nav">
            <ul id="top-menu" class="nav">
              ...
              <li id="menu-item-280" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-280"><a
                  href="quienes-somos.html">QUIÉNES SOMOS</a></li>
              <li id="menu-item-972"
                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-972"><a
                  href="nuestros-productos.php">NUESTROS PRODUCTOS</a>
                <ul class="sub-menu">
                  <li id="menu-item-1320"
                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1320"><a
                      href="aromas.html">AROMAS</a></li>
              ...
              <li id="menu-item-351" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-351"><a
                  ...
                  <div class="et_pb_section et_pb_section_0 et_section_regular">
                    <div class="et_pb_row et_pb_row_0">
                      <div class="et_pb_column et_pb_column_2_5 et_pb_column_0 et_pb_css_mix_blend_mode_passthrough">
                        <div class="et_pb_module et_pb_text et_pb_text_0 et_pb_text_align_left et_pb_bg_layout_light">
                          <div class="et_pb_text_inner">
                            <p style="text-align: center">
                              GRACIAS POR TU COMPRA! PARA COORDINAR LOS
                              RETIROS EN PALERMO POR FAVOR ESCRIBINOS AL
                        ...
                        <!-- .et_pb_text -->
                        <ul
                          class="et_pb_module et_pb_social_media_follow et_pb_social_media_follow_0 et_animated clearfix et_pb_text_align_center et_pb_bg_layout_light">
                          <li
                            ...
                            <a href="https://www.instagram.com/terra_cosmeticanatural/" class="icon et_pb_with_border"
                              title="Seguir en Instagram" target="_blank"><span
                                class="et_pb_social_media_follow_network_name" aria-hidden="true">Seguir</span></a>
                          </li>
                          <li
                      ...
                      <div
                        ...
                        <div id="et_pb_contact_form_0"
                          ...
                          <div class="et_pb_contact">
                            <form class="et_pb_contact_form clearfix" method="post" action="contacto.html">
                              <p class="et_pb_with_border et_pb_contact_field et_pb_contact_field_0 et_pb_contact_field_last"
                                ...
                                <input type="text" id="et_pb_contact_name_0" class="input" value=""
                                  ...
                                  data-original_id="name" placeholder="Nombre" />
                              </p>
                              <p class="et_pb_with_border et_pb_contact_field et_pb_contact_field_1 et_pb_contact_field_half"
                                data-id="email" data-type="email">
                                <label for="et_pb_contact_email_0" class="et_pb_contact_form_label">Dirección de correo
                                  electrónico</label>
                                <input type="text" id="et_pb_contact_email_0" class="input" value=""
                                  ...
                                  data-original_id="email" placeholder="Dirección de correo electrónico" />
                              </p>
                              <p class="et_pb_with_border et_pb_contact_field et_pb_contact_field_2 et_pb_contact_field_half et_pb_contact_field_last"
                                data-id="phone" data-type="input">
                                <label for="et_pb_contact_phone_0" class="et_pb_contact_form_label">Teléfono
                                  (opcional)</label>
                                <input type="text" id="et_pb_contact_phone_0" class="input" value=""
                                  name="et_pb_contact_phone_0" data-required_mark="not_required" data-field_type="input"
                                  data-original_id="phone" placeholder="Teléfono (opcional)" pattern="[0-9\s-]*"
                              ...
                              <p class="et_pb_with_border et_pb_contact_field et_pb_contact_field_3 et_pb_contact_field_last"
                                ...
                                <textarea name="et_pb_contact_message_0" id="et_pb_contact_message_0"
                                  ...
                                  data-field_type="text" data-original_id="message" placeholder="Mensaje"></textarea>
                              </p>
                              ...
                              <input type="hidden" id="_wpnonce-et-pb-contact-form-submitted-0"
                                name="_wpnonce-et-pb-contact-form-submitted-0" value="d348be95fb" /><input type="hidden"
                                name="_wp_http_referer" value="/contacto/" />
                            </form>
                          </div>
                          <!-- .et_pb_contact -->
                        </div>
          ...
          <div class="et_pb_row et_pb_row_1 et_pb_equal_columns">
            <div class="et_pb_column et_pb_column_1_3 et_pb_column_2 et_pb_css_mix_blend_mode_passthrough">
              ...
              <div class="et_pb_module et_pb_text et_pb_text_5 et_pb_text_align_center et_pb_bg_layout_light">
                <div class="et_pb_text_inner">
                  <h6>
                    <a class="email" href="mailto:terracosmeticacontacto@gmail.com">terracosmeticacontacto@gmail.com</a>
                  </h6>
            ...
            <div
              ...
              <ul
                ...
                <li
                  ...
                  <a href="https://www.instagram.com/terra_cosmeticanatural/" class="icon et_pb_with_border"
                    title="Seguir en Instagram" target="_blank"><span class="et_pb_social_media_follow_network_name"
                      aria-hidden="true">Seguir</span></a>
                </li>
                <li
                  class="et_pb_social_media_follow_network_3 et_pb_social_icon et_pb_social_network_link et-social-facebook et_pb_social_media_follow_network_3">
                  <a href="https://www.facebook.com/Terra-Cosm%C3%A9tica-Natural-873989496300527"
                    class="icon et_pb_with_border" title="Seguir en Facebook" target="_blank"><span
                      class="et_pb_social_media_follow_network_name" aria-hidden="true">Seguir</span></a>
                </li>
  ...
  <script type="text/javascript">
    var et_animation_data = [{
      class: "et_pb_social_media_follow_0",
      style: "fade",
      repeat: "once",
      duration: "1000ms",
      delay: "0ms",
  ...
  <script type="text/javascript">
    ...
    var wc_checkout_params = {
      ajax_url: "\/wp-admin\/admin-ajax.php",
      wc_ajax_url: "\/?wc-ajax=%%endpoint%%",
      update_order_review_nonce: "09f982d744",
      apply_coupon_nonce: "77d4ad01f0",
      remove_coupon_nonce: "335077625c",
  ...
  <script type="text/javascript">
    ...
    var wc_cart_fragments_params = {
      ajax_url: "\/wp-admin\/admin-ajax.php",
      wc_ajax_url: "\/?wc-ajax=%%endpoint%%",
      cart_hash_key: "wc_cart_hash_1fb5a270a44ef9734364e79a5c85c66d",
      fragment_name: "wc_fragments_1fb5a270a44ef9734364e79a5c85c66d",
